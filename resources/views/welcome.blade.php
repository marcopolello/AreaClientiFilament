        ...
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                ...
                <nav class="flex justify-end flex-1 -mx-3">
                    ...
                    @else
                        ...
                        <a
                                href="{{ \Filament\Facades\Filament::getCurrentPanel()->getRegistrationUrl() }}"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                            Sign up
                        </a>
            ...
            <main class="mt-6">
                <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                    <a
                            href="https://gitea.enerp.biz/enerp"
                            id="docs-card"
                            ...
                            <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                ...
                                <div class="pt-3 sm:pt-5 lg:pt-0">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                        Documentazione utilizzo portale
                                    </p>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Demo applicazione</h2>
                    ...
                    <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        ...
                        <div class="pt-3 sm:pt-5">
                            <h2 class="text-xl font-semibold text-black dark:text-white">Notizie / Leggi / ecc</h2>
